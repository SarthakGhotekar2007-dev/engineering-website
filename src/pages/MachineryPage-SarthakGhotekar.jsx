          ...
          <div className="team-cta-container">
            ...
            <div className="cta-section section-padding relative">
              ...
              <div className="cta-content-wrapper relative z-10">
                ...
                <button className="btn-primary-tech cta-submit-btn mt-40">REQUEST A QUOTE <ArrowRight size={20} className="btn-icon arrow-smooth" /></button>
              </div>
            </div>
